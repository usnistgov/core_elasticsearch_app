...
from core_elasticsearch_app.components.data.elasticsearch import create_title_autocomplete_index
    ...
    def ready(self):
        ...
        if 'migrate' not in sys.argv:
            if CAN_SET_PUBLIC_DATA_TO_PRIVATE:
                raise ElasticsearchError("The Elasticsearch app will only work for systems where "
